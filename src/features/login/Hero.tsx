    ...
    <>
        ...
        >
          <Grid item md={6} pr={{ xs: 0, md: 3 }}>
            ...
            >
              ...
              your NFTs by staking and growing your digital assets with ease.
              Our platform is designed to take advantage of the booming
              cryptocurrency market, helping you maximize your portfolio during
              the bull run. Whether you’re a beginner or an expert, our
              intuitive interface and robust security make it simple to manage
              your assets and track your progress in real time.
              <br /> Join DARWWIN today and experience a secure, innovative way
              to grow your NFT portfolio. With us, you’re not just investing in
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: `
  window.$crisp=[];window.CRISP_WEBSITE_ID="c254ca73-acf4-4ae4-aea6-2dcec718649a";
