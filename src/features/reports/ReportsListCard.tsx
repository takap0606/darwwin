        ...
        <Box sx={style}>
          <form onSubmit={formik.handleSubmit}>
            ...
            <Box my={2}>
              ...
              <Typography>
                Please note that rewards minus 5% as a withdrawal fee will be
                sent to your designated Bybit wallet. Requests made by the 10th
                will be processed on the 15th. Requests after the 11th will be
                processed on the 15th of the following month.
              </Typography>
            </Box>
